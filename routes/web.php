...
Route::middleware('auth')->prefix('onboarding')->group(function () {
    ...
    // Applied Rounds & Contestants
    Route::post('/apply-round/{voting_id}', [ContestantController::class, 'applyToRound'])->name('contestant.applyToRound');
    Route::get('/round/{voting_id}/contestants', [ContestantController::class, 'getAppliedContestants'])->name('contestant.getAppliedContestants');
});
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // Admin Voting Details & Toggle Status
    Route::get('/voting/detail-modal/{id}', [VotingController::class, 'getVotingDetailsModal'])->name('admin.voting.detail.modal');
    Route::post('/voting/contestant/toggle/{id}', [VotingController::class, 'toggleContestantStatusModal'])->name('admin.voting.contestant.toggle');
