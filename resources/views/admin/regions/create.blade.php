...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h3 class="text-lg font-bold text-gray-800">Create New Region</h3>
            <p class="text-sm text-gray-500 mt-1">Add a new geographical region for contestants to join.</p>
        </div>

        <form action="{{ route('admin.regions.store') }}" method="POST" class="p-6 space-y-4">
